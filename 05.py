...
Kasutaja peab sisestama vastuse.
...
#         print("Vale")
# except:
#     print("Sisesta numbriline väärtus!")
...
try:
    ...
    if arvamus >=0 and arvamus <=1:    # kui tahad teha nii, et saaks valida ainult 0 ja 1 vahel
        if valik == arvamus:
            print("Arvasid ära")
            turtle.color("green")
            turtle.circle(50)
        ...
        print("Sellist valikut ju ei olnud!") # vastus kui sisestad midagi muud kui 0 või 1
except:
    print("Viga sisestamisel!")
